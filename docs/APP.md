...
- **Spark Prompts:** **State-driven** prompt system (taxonomy, phases, feedback, soft named anchors) — **not** implemented in app yet; spec [spark-prompts.md](skills/spark-prompts.md).
