...
export default function EventHubScreen() {
  ...
  const checkInMutation = useCheckInMutation(uid);
          ...
          <>
            ...
            <Card className="mt-6">
              <CardHeader>
                ...
                <CardDescription>
                  Enter the host’s invite code or open an invite URL (code auto-filled in future step).
                </CardDescription>
              </CardHeader>
              <CardContent className="gap-3">
                <Input
            ...
            {membership.status !== 'checked_in' ? (
              <Card className="mt-6">
                <CardHeader>
                  ...
                  <CardDescription>Scan the venue QR (or type the check-in code) to signal presence.</CardDescription>
                </CardHeader>
                <CardContent className="gap-3">
                  <Input
                    autoCapitalize="characters"
